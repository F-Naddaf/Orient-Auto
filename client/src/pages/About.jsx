      ...
      <div className="about-container">
        ...
        <div className="about-company">
          <section>
            ...
            <span className="line"></span>
            <p>
              A <strong>fast and targeted service</strong> , that is what we
              stand for. From choosing a suitable car to returning it at the end
              of the lease contract, we are always there for you. Communication
              is of paramount importance to us. Not only are we easily
              accessible, we ensure that every customer is helped{" "}
        ...
        <div className="about-company">
          ...
          <section>
            ...
            <p>
              ...
              <strong>wide range</strong> of makes and models. We offer the
              right solution for every application and{" "}
              <strong>every budget</strong> . You can view our range at your
              leisure via the website. Of course you can always contact us for
              more information or to submit your specific wishes to us.
            </p>
          ...
          <section>
            ...
            <div>
              ...
              <p>
                ...
                You can also contact Select Car Lease for repairs and
                maintenance.
              </p>
            </div>
